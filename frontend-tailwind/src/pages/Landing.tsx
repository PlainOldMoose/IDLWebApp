...
export default function Landing() {
    ...
    const why_body = "The aim of this project is to replace the back-end currently used by the admins, thus ending Sabata's years of hard work manually entering data into a spreadsheets. " +
        "It also seeks to provide features and tools to players of IDL, such as an in-house balancer and our very own doodle.";
    const how_body = "This project is made 100% by hand, using Java Springboot, React/Tailwind, and a PostgreSQL database. The project is open source, check out the source code and how to contibute here.";
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <InfoCard title={"How?"} body={how_body}/>
            </div>
        </div>
    );
}